...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-garden-mint to-white">
      {/* Header */}
      <header className="bg-white shadow-sm border-b border-garden-yellow">
      ...
      <section className="py-20 text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-5xl font-bold text-garden-dark mb-6">
            Чеснок на посадку
          </h2>
          <p className="text-xl text-garden-green/80 mb-8 max-w-2xl mx-auto">
      ...
      <section id="catalog" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-garden-green/70 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {garlicProducts.map((product) => (
              <Card key={product.id} className="group hover:shadow-xl transition-all duration-300 border-0 bg-card">
                ...
                <CardHeader>
                  <CardTitle className="text-garden-dark text-xl">{product.name}</CardTitle>
                  <p className="text-garden-green/70">{product.description}</p>
                </CardHeader>
      ...
      {/* Guarantees Section */}
      <section className="py-16 bg-garden-mint">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-garden-dark mb-4">Наши гарантии</h3>
            <p className="text-garden-green/70">Мы отвечаем за качество каждой луковицы</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-garden-dark mb-2">Высокая всхожесть</h4>
              <p className="text-garden-green/70 text-sm">До 99% всходов при соблюдении условий посадки</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-garden-dark mb-2">Премиум качество</h4>
              <p className="text-garden-green/70 text-sm">Отбираем только лучшие экземпляры</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-garden-dark mb-2">Защита покупки</h4>
              <p className="text-garden-green/70 text-sm">Возврат средств при неудовлетворительном результате</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-garden-dark mb-2">Быстрая доставка</h4>
              <p className="text-garden-green/70 text-sm">Отправляем в течение 24 часов по всей России</p>
            </div>
          </div>
        </div>
      </section>
